...
public class JSONResourceReader {
    ...
    public JSONResourceReader(Resources resources, int id) {
        ...
        try {
            ...
            Timber.e("Unhandled exception while using JSONResourceReader : %s", e.toString());
        } finally {
            try {
    ...
    static JSONObject getJsonObject(Context context, @RawRes int rawResId) {
        ...
        try {
            ...
            Timber.e(ex, "Error in getJsonObject");
        }
        return result;
    }
